...
const Index = () => {
  ...
  if (screen.type === "exam") {
    return (
      <Suspense fallback={<LoadingFallback />}>
        <ExamScreen
          key={`${screen.subject.id}-${Date.now()}`}
          subject={screen.subject}
  ...
  return (
    <div className="min-h-screen paper-texture relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        {/* New Hero Section */}
        <div className="flex flex-col lg:flex-row items-center gap-16 min-h-[100vh] py-20">
          {/* Left Column: Text Content */}
          <div className="flex-1 text-left animate-fade-in">
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-accent/10 border border-border mb-8 backdrop-blur-xl shadow-2xl">
            ...
            <h1 className="font-heading text-6xl md:text-8xl font-black text-foreground mb-8 tracking-tighter leading-[0.95] text-balance">
              Master Your <br />
            ...
            <p className="text-muted-foreground text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-medium text-balance">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <p className="text-xs text-muted-foreground/60 font-bold uppercase tracking-widest ml-2">
                Join 2,000+ Students
              </p>
            </div>
          </div>
          ...
          <div className="flex-1 relative w-full max-w-lg lg:max-w-none animate-scale-in transform-gpu">
            <div className="relative aspect-square md:aspect-video lg:aspect-square w-full">
              ...
              <div className="absolute inset-0 glass-card rounded-[3rem] p-8 flex items-center justify-center overflow-hidden border-white/5">
                ...
                <div className="grid grid-cols-2 gap-6 w-full relative z-10">
                  {heroItems.map((item) => (
                    ...
                    >
                      <div className={`hero-card ${item.floatClassName} p-6`}>
                        <LucideIcon name={item.icon} className={`${item.iconClassName} mb-4`} size={32} />
        ...
        {/* Section Title */}
        <div id="subjects-grid" className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6 animate-fade-in">
          <div>
            <h2 className="text-4xl md:text-5xl font-heading font-black mb-4">Core Curriculum</h2>
