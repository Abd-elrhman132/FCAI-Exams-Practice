    ...
    <div className="min-h-screen paper-texture pb-20">
      ...
      <div className="sticky top-0 z-20 bg-background/80 backdrop-blur-md border-b border-white/5 shadow-lg shadow-black/10">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-4 min-w-0">
            <button 
              onClick={onBack}
              className="btn-hover-base btn-hover-soft btn-hover-lift rounded-full p-2 text-muted-foreground hover:bg-white/5 hover:text-foreground"
            >
              <LucideIcon name="ArrowLeft" size={20} />
            </button>
            <div className="flex items-center gap-3">
              <div 
                className="w-10 h-10 rounded-lg flex items-center justify-center hidden sm:flex"
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-64 flex-shrink-0 order-2 lg:order-1">
          <div className="lg:sticky lg:top-32 bg-white/5 border border-white/10 rounded-2xl p-5 backdrop-blur-sm shadow-xl">
              ...
              {exam.questions.map((_, i) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => exam.goTo(i)}
                    className={cn(
                      "btn-hover-base btn-hover-soft aspect-square rounded-lg text-xs font-bold transition-all duration-300",
                      isActive 
        ...
        <div className="flex-1 order-1 lg:order-2">
          <div className="bg-card/40 backdrop-blur-sm rounded-3xl border border-white/10 p-6 md:p-10 shadow-2xl relative overflow-hidden group">
          ...
          <div className="flex justify-between items-center mt-8 gap-4">
            <button
              ...
              className="btn-hover-base btn-hover-soft btn-hover-lift flex items-center gap-2 rounded-xl border border-white/10 px-6 py-3 text-sm font-bold text-foreground hover:bg-white/5 disabled:opacity-20 disabled:pointer-events-none"
            >
            ...
            {exam.isLast ? (
              <button
                onClick={handleSubmitClick}
                className="btn-hover-base btn-hover-solid btn-hover-lift rounded-xl px-10 py-3 text-sm font-black uppercase tracking-widest shadow-xl"
                style={{ 
                  "--btn-glow": `${subject.color}80`,
                  backgroundColor: subject.color, 
                  color: "#fff",
              ...
              <button
                ...
                className="btn-hover-base btn-hover-solid btn-hover-lift flex items-center gap-2 rounded-xl px-8 py-3 text-sm font-bold shadow-xl disabled:opacity-30 disabled:pointer-events-none"
                style={{ 
                  "--btn-glow": `${subject.color}80`,
                  backgroundColor: subject.color, 
                  color: "#fff",
